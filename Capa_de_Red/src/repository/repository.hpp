...
namespace repo {
    ...
    public:
        ...
        expected_t<>                    insert_time_rule(int condition_type_id, int actuator_type_id, std::string_view condition_time);
        ...
        expected_t<std::vector<time_rule>>   get_time_rules_ordered();
